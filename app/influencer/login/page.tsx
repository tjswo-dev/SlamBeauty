  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-violet-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <Link href="/influencer/campaigns" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 mb-8 transition-colors">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-purple-100/50 border border-purple-100 p-8">
          <div className="text-center mb-8">
            ...
            <div className="text-xs font-semibold text-purple-500 tracking-wider uppercase mb-1">For Influencer</div>
            <h1 className="text-2xl font-bold text-slate-900">K-뷰티 브랜드와 함께하세요</h1>
            <p className="text-sm text-slate-500 mt-2 leading-relaxed">캠페인을 탐색하고 나에게 맞는 브랜드와 협업하세요</p>
          </div>
          <button
          ...
          <p className="text-xs text-slate-400 text-center mt-6 leading-relaxed">
            로그인하면 <span className="underline cursor-pointer">이용약관</span> 및 <span className="underline cursor-pointer">개인정보처리방침</span>에 동의합니다
          </p>
        </div>
      </div>
    </div>
